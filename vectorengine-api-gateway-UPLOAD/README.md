...
| GitHub Issues (docs / links only) | [Issues](https://github.com/Archer-ai-hub/vectorengine-api-gateway/issues) |

**Optional:** enable **GitHub Pages** on `main` → `/docs` to render Markdown in browser, or add your long-form English HTML under `docs/` and link it here.
...
| **3** | [GitHub Issues](https://github.com/Archer-ai-hub/vectorengine-api-gateway/issues) | README / doc typos, broken links — not for account-specific support. |
...
## Maintainer checklist (GitHub repo settings)

Things README alone cannot fix — worth doing on [the repo](https://github.com/Archer-ai-hub/vectorengine-api-gateway):
...
| **Pinned README preview** | Avoid a **second `#` title** above this file in GitHub’s editor (duplicate H1 looks unpolished). |
